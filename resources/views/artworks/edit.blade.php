...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Edit Artwork Number {{ $artwork->id }}'s Information</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="inventory_number"
                        value="{{ $artwork->inventory_number }}" placeholder="Enter an inventory_number" required>
                </div>

                <div class="form-group">
                    <label for="type">Type</label>
                    <select class="form-control" name="type" value="{{ $artwork->type }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title"
                        value="{{ $artwork->title }}"placeholder="Enter a title" required>
                </div>
                ...
                <div class="form-group">
                    <label for="artist_id">Artist</label>
                        ...
                        @foreach ($availableArtists as $artist)
                            <option value="{{ $artist->id }}" @if($artist->id == $artwork->artist_id) selected @endif>{{ $artist->first_name }} {{ $artist->last_name }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="support" value="{{ $artwork->support }}"
                        placeholder="Enter a support" required>
                </div>

                <div class="form-group">
                    <label for="height">Height</label>
                    <input type="text" class="form-control" name="height" value="{{ $artwork->height }}"
                        placeholder="Enter the height">
                </div>

                <div class="form-group">
                    <label for="width">Width</label>
                    <input type="text" class="form-control" name="width" value="{{ $artwork->width }}"
                        placeholder="Enter the width">
                </div>

                <div class="form-group">
                    <label for="depth">Depth</label>
                    <input type="text" class="form-control" name="depth" value="{{ $artwork->depth }}"
                        placeholder="Enter the depth">
                </div>

                <div class="form-group">
                    <label for="weight">Weight</label>
                    <input type="text" class="form-control" name="weight" value="{{ $artwork->weight }}"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="elements_number"
                        value="{{ $artwork->elements_number }}" placeholder="Enter the elements_number">
                </div>

                <div class="form-group">
                    <label for="print_number">Print Number</label>
                    <input type="text" class="form-control" name="print_number" value="{{ $artwork->print_number }}"
                        placeholder="Enter the print_number" required>
                </div>

                <div class="form-group">
                    <label for="print_type">Print Type</label>
                    <input type="text" class="form-control" name="print_type" value="{{ $artwork->print_type }}"
                        placeholder="Enter the print_type" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="signature" value="{{ $artwork->signature }}"
                        placeholder="Enter a signature" required>
                </div>

                <div class="form-group">
                    <label for="signature_location">Signature Location</label>
                    <input type="text" class="form-control" name="signature_location"
                        value="{{ $artwork->signature_location }}" placeholder="Enter a signature_location" required>
                </div>

                <div class="form-group">
                    <label for="conservation_location">Conservation Location</label>
                    <input type="text" class="form-control" name="conservation_location"
                        value="{{ $artwork->conservation_location }}" placeholder="Enter a conservation_location" required>
                </div>

                <div class="form-group">
                    <label for="storage_place">Storage Place</label>
                    <input type="text" class="form-control" name="storage_place"
                        value="{{ $artwork->storage_place }}" placeholder="Enter a storage_place" required>
                </div>

                <div class="form-group">
                    <label for="storage_method">Storage Method</label>
                    <select class="form-control" name="storage_method" value="{{ $artwork->storage_method }}">
