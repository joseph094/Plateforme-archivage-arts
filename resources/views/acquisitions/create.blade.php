...
@section('content')
    ...
    <div class="card card-primary">
        <div class="card-header">
            <h3 class="card-title">Create new Acquisition</h3>
        </div>
        <!-- /.card-header -->
        <!-- form start -->
        <form method="post" action="/acquisition">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="artwork_id" placeholder="Enter the artwork_id">
                </div>

                <div class="form-group">
                    <label for="current_owner">Current Owner</label>
                    <input type="text" class="form-control" name="current_owner" placeholder="Enter the current_owner">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="acquisition_location"
                        placeholder="Enter a acquisition_location">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="acquisition_method">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="proof_of_purchase"
                        placeholder="Enter a proof_of_purchase">
                </div>
