    ...
    <body>
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">{{ __('Restoration List') }}</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
        ...
        <div class="content">
            <div class="container-fluid">
                <div>
                    <a href="/restoration/create" class="btn btn-primary mb-3">Declare New Restoration</a>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <form action="{{ route('restoration.search') }}" method="get">
                                    ...
                                    <form action="{{ route('restoration.filter') }}" method="get">
                                ...
                                <script type="text/javascript">
                                    var route = "{{ url('/restoration/autocomplete') }}";
                                    $('#search').typeahead({
                                    ...
                                    <tbody>
                                        @foreach ($restorations as $restoration)
                                            <tr>
                                                ...
                                                <td>{{ $restoration->artwork_id }}</td>
                                                <td>{{ $restoration->diagnosis }}</td>
                                                <td>{{ $restoration->causes }}</td>
                                                <td>{{ $restoration->start_date }}</td>
                                                <td>{{ $restoration->end_date }}</td>
                                                ...
                                                @if ($restoration->user_id == auth()->user()->id || auth()->user()->role == "superadmin")
                                                <td>
                                                    <a href="/restoration/{{ $restoration->id }}/edit"
                                                        class="btn btn-primary">Edit</a>
                                                </td>
                                                <td>
                                                    <form action="{{ route('restoration.destroy', $restoration->id) }} "
                                                        method="post">
                                                        @csrf
                                                        @method('DELETE')
